...
import 'package:hairdresser/custom_widgets/custom_button.dart';
import 'package:hairdresser/mixins/validation_mixin.dart';
import 'package:hairdresser/models/event.dart';
import 'package:hairdresser/services/db_service.dart';
import 'package:hairdresser/utils/database_helper.dart';
...
class _AddEventState extends State<AddEvent> with ValidationMixin {
  ...
  TimeOfDay _time;
  bool processing;
  String header = "Add New Appointment";
                  ...
                  child: MediaQuery.removePadding(
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        ...
                        ListTile(
                          title: Text("Select Date of Appointment"),
                          subtitle: Text(
                        ...
                        SizedBox(height: 10.0),
                        ListTile(
                          title: Text("Select Time of Appointment"),
